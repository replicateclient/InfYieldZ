...
function randomString()
	return "VerySigmaElementOfIYZTrust"
end
...
local Themes = {
	-- Ocean: cool teal/blue modern
	ocean = {
		base = Color3.fromRGB(18, 24, 28),
		text = Color3.fromRGB(232, 240, 244),
		gradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(70, 160, 220)),
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(30, 200, 180)),
		},
	},
-- Cyberpunk: High-contrast neon yellow and cyan
    cyberpunk = {
        base = Color3.fromRGB(15, 15, 20),
        text = Color3.fromRGB(255, 255, 255),
        gradient = ColorSequence.new{
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 240, 30)), -- Neon Yellow
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 255, 255)),   -- Cyan
        },
    },

    -- Gold: Luxury/VIP style with a metallic sheen
    gold = {
        base = Color3.fromRGB(25, 22, 15),
        text = Color3.fromRGB(255, 250, 230),
        gradient = ColorSequence.new{
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 215, 100)),
            ColorSequenceKeypoint.new(0.50, Color3.fromRGB(200, 160, 60)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 230, 150)),
        },
    },

    -- Lavender: Soft, dreamy purple
    lavender = {
        base = Color3.fromRGB(22, 20, 30),
        text = Color3.fromRGB(245, 240, 255),
        gradient = ColorSequence.new{
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(160, 140, 255)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(200, 160, 255)),
        },
    },

    -- Sakura: Soft white and cherry blossom pink
    sakura = {
        base = Color3.fromRGB(30, 20, 25),
        text = Color3.fromRGB(255, 240, 245),
        gradient = ColorSequence.new{
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 183, 197)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 120, 160)),
        },
    },

    -- Frost: Cold white and icy blue
    frost = {
        base = Color3.fromRGB(20, 25, 30),
        text = Color3.fromRGB(240, 250, 255),
        gradient = ColorSequence.new{
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(200, 240, 255)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(100, 180, 240)),
        },
    },
    
    -- Amber: Warm, burnt wood and glowing orange
    amber = {
        base = Color3.fromRGB(20, 15, 10),
        text = Color3.fromRGB(255, 245, 230),
        gradient = ColorSequence.new{
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 170, 50)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(200, 80, 20)),
        },
    },
	-- Nebula: futuristic violet/teal glow
	nebula = {
		base = Color3.fromRGB(20, 22, 28),
		text = Color3.fromRGB(240, 244, 248),
		gradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(80, 200, 200)),
			ColorSequenceKeypoint.new(0.50, Color3.fromRGB(100, 120, 255)),
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(210, 120, 255)),
		},
	},

	-- Sunset: warm orange-pink
	sunset = {
		base = Color3.fromRGB(24, 18, 18),
		text = Color3.fromRGB(248, 240, 236),
		gradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 125, 90)),
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 80, 160)),
		},
	},

	-- Midnight: true dark mode with royal blue edges
	midnight = {
		base = Color3.fromRGB(10, 12, 18),
		text = Color3.fromRGB(235, 240, 255),
		gradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(20, 40, 80)),
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(80, 140, 220)),
		},
	},

	-- Emerald: clean dark-green glass style
	emerald = {
		base = Color3.fromRGB(14, 22, 18),
		text = Color3.fromRGB(230, 245, 238),
		gradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(40, 220, 150)),
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(20, 160, 100)),
		},
	},

	-- Crimson: red/rose theme (great for alert UIs)
	crimson = {
		base = Color3.fromRGB(28, 18, 18),
		text = Color3.fromRGB(250, 235, 240),
		gradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 90, 90)),
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(180, 30, 60)),
		},
	},

	-- Discord: based on Discord's slate purple-gray tone
	discord = {
		base = Color3.fromRGB(54, 57, 63),
		text = Color3.fromRGB(255, 255, 255),
		gradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(88, 101, 242)),
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(114, 137, 218)),
		},
	},

	-- Matrix: black/green terminal style
	matrix = {
		base = Color3.fromRGB(5, 10, 5),
		text = Color3.fromRGB(0, 255, 120),
		gradient = ColorSequence.new{
	...
	-- Rose: elegant dark pink + soft magenta
	rose = {
		base = Color3.fromRGB(25, 18, 24),
		text = Color3.fromRGB(255, 240, 250),
		gradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 100, 150)),
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(190, 90, 200)),
		},
	},

	-- Halloween: dark charcoal with pumpkin and ember glow
	halloween = {
		base = Color3.fromRGB(20, 14, 10), -- deep dark brownish-black
		text = Color3.fromRGB(255, 230, 200), -- warm light text
		gradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 140, 40)),  -- pumpkin orange
			ColorSequenceKeypoint.new(0.50, Color3.fromRGB(200, 60, 20)),   -- ember red
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 180, 80)),  -- soft gold edge
		},
	},

	-- Christmas: cozy red + green gradient
	christmas = {
		base = Color3.fromRGB(18, 20, 18),
		text = Color3.fromRGB(245, 250, 245),
		gradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(200, 40, 40)),  -- holly red
			ColorSequenceKeypoint.new(0.50, Color3.fromRGB(40, 200, 80)),  -- pine green
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(230, 70, 50)),  -- warm red
		},
	},
...
local TAG = "ModernUI"
local DEFAULT_CORNER = 8

-- ===== ROOTS =====
local function getRoots()
	-- Try common IY containers + Cmdbar
	local roots = {}

	-- Infinite Yield in CoreGui
	local iy = Main
	if iy then table.insert(roots, iy) end


	-- Cmdbar (if present)
	if typeof(Cmdbar) ~= "nil" and Cmdbar and Cmdbar.Parent then
		table.insert(roots, Cmdbar)
	end
...
local function ensureCorner(obj)
	...
	if existing then
		-- Keep user's larger radius; bump if smaller than desired
		if existing.CornerRadius.Scale == 0 and existing.CornerRadius.Offset < DEFAULT_CORNER then
			existing.CornerRadius = UDim.new(0, DEFAULT_CORNER)
		end
		return existing
	end
	local c = Instance.new("UICorner")
	c.Name = TAG .. "_Corner"
	c.CornerRadius = UDim.new(0, DEFAULT_CORNER)
	c.Parent = obj
	return c
end

local function removeOurAdorners(obj)
	for _, ch in ipairs(obj:GetChildren()) do
		if (ch:IsA("UIGradient") and ch.Name == TAG .. "_Grad")
			or (ch:IsA("UIScale") and ch.Name == TAG .. "_Scale")
			or (ch:IsA("UICorner") and ch.Name == TAG .. "_Corner")
		then
			ch:Destroy()
		end
	end
...
local function applyGradient(obj)
	-- Replace our previous gradient (only ours)
	for _, g in ipairs(obj:GetChildren()) do
		if g:IsA("UIGradient") and g.Name == TAG .. "_Grad" then g:Destroy() end
	end
	local grad = Instance.new("UIGradient")
	grad.Name = TAG .. "_Grad"
	grad.Color = THEME.gradient
	grad.Rotation = 25
	grad.Parent = obj
	return grad
end
...
local function animateButton(btn)
	...
	local scale = btn:FindFirstChild(TAG .. "_Scale") or Instance.new("UIScale")
	scale.Name = TAG .. "_Scale"
	scale.Scale = 1
	scale.Parent = btn

	btn.MouseEnter:Connect(function()
		TweenService:Create(scale, TweenInfo.new(0.18, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Scale = 1.03}):Play()
	end)
	btn.MouseLeave:Connect(function()
		TweenService:Create(scale, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Scale = 1.0}):Play()
	end)
end

local function styleText(obj)
	obj.TextColor3 = THEME.text
	if obj.Font == Enum.Font.SourceSans or obj.Font == Enum.Font.Legacy then
		obj.Font = Enum.Font.GothamMedium
	end
end

-- IMPORTANT: Always add corners, but only recolor/gradient if the panel is visibly opaque
local function stylePanel(obj)
	-- Corners first (always)
	ensureCorner(obj)

	-- Skip recolor/gradient on ScreenGui/3D/very transparent to avoid overlays
	if obj:IsA("ScreenGui") or obj:IsA("BillboardGui") or obj:IsA("ViewportFrame") then
		return
	end

	-- Only apply surface styling when the panel is visible (opaque-ish)
	if obj:IsA("GuiObject") and obj.BackgroundTransparency < 0.5 then
		obj.BackgroundColor3 = THEME.base
		applyGradient(obj)
	end
end

local function styleOne(v)
	if v:IsA("Frame") or v:IsA("ScrollingFrame") or v:IsA("ImageLabel") then
		stylePanel(v)
	elseif v:IsA("TextButton") then
		styleText(v); ensureCorner(v); applyGradient(v); animateButton(v)
	elseif v:IsA("TextLabel") or v:IsA("TextBox") then
		styleText(v); ensureCorner(v)
	end
end

local function restyleRoot(root)
	for _, d in ipairs(root:GetDescendants()) do
		if d:IsA("GuiObject") then
			removeOurAdorners(d) -- clear our old adorners so re-style is clean
		end
	end
	for _, d in ipairs(root:GetDescendants()) do
		if d:IsA("GuiObject") then
...
-- === Seasonal Auto-Theme + Dynamic Title Handling ===
local function applySeasonalTheme()
	local month = tonumber(os.date("%m"))
	local emoji, chosenTheme = nil, nil
	local version = currentVersion
	local baseTitle = "Infinite Yield Z"

	-- Seasonal logic
	if month == 10 then
		chosenTheme = "halloween"
		emoji = "🎃"
	elseif month == 12 or month == 1 then
		chosenTheme = "christmas"
		emoji = "🎄"
	end
	...
	local titleLabel = iy and iy:FindFirstChild("Title", true)

	-- Theme + title update logic
	if chosenTheme and Themes[chosenTheme] then
		THEME = Themes[chosenTheme]
		print(("[ModernUI] Auto-applied seasonal theme: %s"):format(chosenTheme))
		restyleAll()

		-- Update title text and color
		if titleLabel and titleLabel:IsA("TextLabel") then
			_G.OriginalTitleText = ("%s (%s)"):format(baseTitle, "v"..version)
			titleLabel.Text = ("%s %s (%s)"):format(baseTitle, emoji, "v"..version)
			titleLabel.TextColor3 = THEME.text
		end
	else
		-- Normal month — revert to default
		if titleLabel and titleLabel:IsA("TextLabel") then
			titleLabel.Text = ("%s (%s)"):format(baseTitle, "v"..version)
			titleLabel.TextColor3 = THEME.text
		end
	end
end
...
Cmdbar.TextColor3 = Color3.fromRGB(224, 224, 224)
...
Credits.Text = "Edge // Zwolf // Moon // Toon // ReplicateClientation"
...
CMDs[#CMDs + 1] = {NAME = 'settheme [name]', DESC = 'Set a theme in IYZ'}
CMDs[#CMDs + 1] = {NAME = 'themelist', DESC = 'Lists all themes in IYZ'}
...
-- store the original title text globally so we can restore it
_G.OriginalTitleText = _G.OriginalTitleText or nil

local oldSetTheme = addcmd and addcmd
addcmd("settheme", {}, function(args, speaker)
	local name = args[1] and args[1]:lower() or ""
	if Themes[name] == nil then
		warn("Usage: ;settheme <ocean|nebula|sunset|midnight|emerald|crimson|frost|discord|matrix|rose|halloween|christmas>")
		return
	end

	THEME = Themes[name]
	print("[ModernUI] Theme set to:", name)
	restyleAll()
...
addcmd("themelist", {}, function(args, speaker)
	local list = {}
	...
	table.sort(list)
	local formatted = table.concat(list, ", ")

	if typeof(notify) == "function" then
		notify("Themes", "Available themes:\n" .. formatted)
	else
		print("Available themes:", formatted)
	end
end)
